package educative.solution.grokkingdp.knapsack.dp;
...
/*
* Time complexity
As we avoided redundant calculations by storing all the intermediate results in a 2-D table, the time complexity of this approach is reduced to
�
(
�
×
...
�
n
 is the number of elements in the input array, and
�
S
...
O(n×S)
 space in memory to store intermediate values.*/
